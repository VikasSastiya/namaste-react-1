...
//  instead of const RestaurantCard=(props)=> { we can also write const RestaurantCard=({resName,cuisine})=> {
    // here also change from <h3>{props.resName}</h3>  <h4>{props.cuisine}</h4>  inplace of   <h3>{resName}</h3>   <h4>{cuisine}</h4> like this
   ...
   const RestaurantCard=(props)=> {
    ...
    // console.log(props);
//  similar like  const RestaurantCard=({resName,cuisine})=> {
    //   i want to say 
    // const {resName,cuisine}=props;so some people would like to code like above    
    ...
    //          className="res-logo"
    //          alt="res-logo"
    //           src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/9/23/d60b3bad-b4c5-4493-b8f9-008fc2e3d3fc_960617.jpg"/>
    ...
    return (
        <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
            <img
                className="res-logo"
                alt="res-logo"
                src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId}   // we are using javascript here so we put the image id in curlybraces
            />
            <h3>{name}</h3>   
   ...
   // here .join is usedfor commas seprating in cuisines for more knowledge visit array join javascript
...
analytics: {},
cta: {
    link: "https://www.swiggy.com/city/indore/shree-leela-restaurant-chhoti-gwaltoli-sarwate-bus-stand-rest67501",
    text: "RESTAURANT_MENU",
    type: "WEBLINK"
},
widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
...
info: {
    id: "104482",
    name: "Rajkamal Dal Bafle",
    cloudinaryImageId: "h5dwfmpvwj3tq3v5bqh8",
    locality: "Chhoti Gwaltoli",
...
analytics: {},
cta: {
    link: "https://www.swiggy.com/city/indore/rajkamal-dal-bafle-chhoti-gwaltoli-rest104482",
    text: "RESTAURANT_MENU",
    type: "WEBLINK"
},
widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
...
info: {
    ...
    availability: {
        nextCloseTime: "2024-09-30 22:00:00",
        opened: true
    },
    badges: {
        imageBadges: [
...
analytics: {},
cta: {
    link: "https://www.swiggy.com/city/indore/vijayshree-sandwich-mahalakshmi-nagar-rest90540",
    text: "RESTAURANT_MENU",
    type: "WEBLINK"
},
widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
...
info: {
    ...
    availability: {
        nextCloseTime: "2024-09-30 21:00:00",
        opened: true
    },
    badges: {
        imageBadges: [
...
},
{
    info: {
        ...
        cloudinaryImageId: "RX_THUMBNAIL/IMAGES/VENDOR/2024/9/26/667a8e8f-0ba0-4ca1-a0a8-949c60914880_303548.jpg",
        locality: "8th Block",
        ...
        availability: {
            nextCloseTime: "2024-09-30 21:35:00",
            opened: true
        },
        badges: {
            imageBadges: [
    ...
    analytics: {},
    cta: {
        link: "https://www.swiggy.com/city/bangalore/ajji-ruchi-kitchen-8th-block-koramangala-rest303548",
        text: "RESTAURANT_MENU",
        type: "WEBLINK"
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
},
{
    info: {
        id: "414271",
        name: "THAR the taste of Rajasthan",
        cloudinaryImageId: "m3x3al2przwmyrnqmfpw",
        locality: "koramangala",
        areaName: "Jyothi Niwas college toad",
        costForTwo:100,
        cuisines: [
            "North Indian",
            "Rajasthani"
    ...
    analytics: {},
    cta: {
        link: "https://www.swiggy.com/city/bangalore/thar-the-taste-of-rajasthan-koramangala-jyothi-niwas-college-toad-rest414271",
        text: "RESTAURANT_MENU",
        type: "WEBLINK"
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
},
{
    info: {
      ...
      availability: {
        nextCloseTime: "2024-09-30 16:55:00",
        opened: true
      },
      badges: {
        imageBadges: [
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/city/bangalore/shyamjis-chole-bhature-5th-block-koramangala-rest592285",
      text: "RESTAURANT_MENU",
      type: "WEBLINK"
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
  },
  {
    info: {
      id: "765466",
      name: "Sri Udupi Swadista",
      cloudinaryImageId: "2be8b0a11646cb3fff259780eabb0957",
      locality: "2nd Stage",
      areaName: "Sri Udupi Swadista",
      costForTwo:200,
      cuisines: [
        "Chinese",
        "South Indian",
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/city/bangalore/sri-udupi-swadista-2nd-stage-sri-udupi-swadista-rest765466",
      text: "RESTAURANT_MENU",
      type: "WEBLINK"
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
  },
  {
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/city/bangalore/gopaljee-cafe-koramangala-rest437907",
      text: "RESTAURANT_MENU",
      type: "WEBLINK"
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
  }];
//    how  data come on in our website,it comes in the form of json,so 
// as shown below code  <RestaurantCard resData={resData[0]}/>if there are more data then insted of increasing length of code we should looping our code
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                ...
                <RestaurantCard resData={resData[12]}/> */}
                {
                    ...
                    {/* not using keys is not acceptible ,index as a key is far better but unique key is best practice */}
